...
export TRANSCRIBE_CLI="$AGENTS_SKILLS_HOME/media/transcribe-audio/scripts/transcribe_diarize.py"
```

Curated skills in this tree live under `${AGENTS_SKILLS_HOME}` (default: `~/.agents/skills`).
