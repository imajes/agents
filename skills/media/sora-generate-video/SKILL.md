---
name: sora-generate-video
description: "Use when the user asks to generate, remix, poll, list, download, or\
  \ delete Sora videos via OpenAI\u2019s video API using the bundled CLI (`scripts/sora.py`),\
  \ including requests like \u201Cgenerate AI video,\u201D \u201CSora,\u201D \u201C\
